...
public class LightingKitchen_2 extends AppCompatActivity {
    ...
    public static final String savedLight = "SavedLightingKitchen_2";
    public static final String savedTemp = "1SavedTemperature_2";
    public static final String savedColor = "SavedBackgroundColor_2";
    public static final String savedLightSettings = "SavedLightSettings_Kitchen_2";
    ...
    /**
     * sets all toggle off buttons to true
     */
        ...
        settingsDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                ...
                if(medChanged && minChanged) {
                    AlertDialog.Builder add = new AlertDialog.Builder(LightingKitchen_2.this);
