...
public class LightingBathroom_3 extends AppCompatActivity {
    ...
    public static final String savedLightSettings = "SavedLightSettings_Bathroom_3";
...
protected View.OnClickListener light_all__off_Listener6 = new View.OnClickListener() {
    ...
    /**
     * sets toggle button to off and bools to false
     */
        ...
        settingsDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                ...
                if(medChanged && minChanged) {
                    AlertDialog.Builder add = new AlertDialog.Builder(LightingBathroom_3.this);
