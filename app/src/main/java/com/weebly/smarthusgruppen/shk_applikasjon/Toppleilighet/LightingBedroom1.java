...
/**
 * Controls all the lights for the bedroom1 Light settings based on mode. Therse settings are
 * also saved in shared preferences
 */
public class LightingBedroom1 extends AppCompatActivity {

    public static final String savedLight = "SavedLightingBedroom1_1";
    public static final String savedTemp = "1SavedTemperature_1";
    public static final String savedColor = "SavedBackgroundColor_1";
    public static final String savedLightSettings = "SavedLightSettings_Bedroom1_1";
        ...
        settingsDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                ...
                if(medChanged && minChanged) {
                    AlertDialog.Builder add = new AlertDialog.Builder(LightingBedroom1.this);
