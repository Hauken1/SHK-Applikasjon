...
public class LightingBathroom extends AppCompatActivity {
    ...
    public static final String savedLightSettings = "SavedLightSettings_Bathroom_1";
    ...
    /**
     * turns off every single button and sets every single bool to false
     */
    ...
    /**
     * actives toggle buttons for off 1-5
     */
        ...
        settingsDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                ...
                if(medChanged && minChanged) {
                    AlertDialog.Builder add = new AlertDialog.Builder(LightingBathroom.this);
